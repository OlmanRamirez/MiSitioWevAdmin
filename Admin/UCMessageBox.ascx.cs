...
";
        ...
        public void ShowMessage(string mesagge)
        {
            ...
            Page.ClientScript.RegisterStartupScript(Page.GetType(), "Olman Ramirez", "showMessage('" + this.ClientID + "',0);", true);
            return;
        }
        /// <summary>
        ///  ShowMessage
        ...
        public void ShowMessage(string mesagge, paginaBase.MessageType type)
        {
            ...
            switch (type)
            {
                case paginaBase.MessageType.Error:
                    Page.ClientScript.RegisterStartupScript(Page.GetType(), "Ramirez", "showMessage('" + this.ClientID + "',0);", true);
